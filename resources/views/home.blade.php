        ...
        <footer class="bg-white/90 dark:bg-dark-card/90 glass backdrop-blur-xl border-t border-light-border dark:border-dark-border">
            <div class="max-w-6xl mx-auto px-6 py-12">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <a href="#" class="text-xl font-black bg-gradient-to-r from-accent-red via-accent-purple to-accent-pink bg-clip-text text-transparent inline-block">
                            Arash-abraham
                        </a>
                        <p class="text-light-muted dark:text-dark-muted text-xs mt-2 leading-relaxed">
                            توسعه‌دهنده بک‌اند، عاشق لینوکس. اینجا درباره تکنولوژی، کد و زندگی می‌نویسم.
                        </p>
                        <div class="flex gap-2 mt-4">
                            <a href="#" class="p-1.5 bg-accent-purple/10 rounded-lg hover:bg-accent-purple/20 transition hover:scale-110">
                    ...
                    <div>
                        <h3 class="font-bold mb-4 text-sm">آخرین پست‌ها</h3>
                        <div class="space-y-3">
                            <a href="#" class="group flex items-start gap-2 p-2 rounded-lg hover:bg-white/50 dark:hover:bg-dark-card/50 transition">
                                <div class="w-8 h-8 bg-gradient-to-br from-accent-purple to-accent-red rounded flex items-center justify-center text-white text-xs font-bold shrink-0">
                                    ل
                                </div>
                                <div>
                                    <h4 class="text-xs font-medium group-hover:text-accent-purple transition line-clamp-1">لینوکس روی سیستم گیمینگ</h4>
                                    <p class="text-xs text-light-muted dark:text-dark-muted">۶ نوامبر</p>
                                </div>
                            </a>
                            
                            <a href="#" class="group flex items-start gap-2 p-2 rounded-lg hover:bg-white/50 dark:hover:bg-dark-card/50 transition">
                                <div class="w-8 h-8 bg-gradient-to-br from-accent-red to-accent-pink rounded flex items-center justify-center text-white text-xs font-bold shrink-0">
                                    P
                                </div>
                                <div>
                                    <h4 class="text-xs font-medium group-hover:text-accent-purple transition line-clamp-1">چرا هنوز از PHP استفاده می‌کنم؟</h4>
                                    <p class="text-xs text-light-muted dark:text-dark-muted">۵ نوامبر</p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="mt-8 pt-6 border-t border-light-border dark:border-dark-border">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-light-muted dark:text-dark-muted">
                        <p>© ۱۴۰۴ Arash-abraham</p>
                        <p>ساخته شده با Tailwind و عشق</p>
                    </div>
                </div>
            </div>
        </footer>
