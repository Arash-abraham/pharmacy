            ...
            <div class="max-w-7xl mx-auto px-6 py-16">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div class="md:col-span-2">
                        ...
                        <p class="text-light-muted dark:text-dark-muted text-sm mt-4 leading-relaxed max-w-md">
                    ...
                    <div>
                        <h3 class="font-bold mb-5">آخرین پست‌ها</h3>
                        <div class="space-y-4">
                            <a href="#" class="group flex items-start gap-3 p-3 rounded-lg hover:bg-white/50 dark:hover:bg-dark-card/50 transition">
                                <div class="w-12 h-12 bg-gradient-to-br from-accent-purple to-accent-red rounded-lg flex items-center justify-center text-white text-xs font-bold shrink-0">
                                    لینوکس
                                </div>
                                <div>
                            ...
                            <a href="#" class="group flex items-start gap-3 p-3 rounded-lg hover:bg-white/50 dark:hover:bg-dark-card/50 transition">
                                <div class="w-12 h-12 bg-gradient-to-br from-accent-red to-accent-pink rounded-lg flex items-center justify-center text-white text-xs font-bold shrink-0">
                                    PHP
                                </div>
                                <div>
                    ...
                    <div class="md:col-span-3">
                        <div class="bg-gradient-to-r from-accent-purple/10 to-accent-red/10 rounded-2xl p-6 border border-accent-purple/20">
                            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                                <div class="text-center md:text-right">
                                    <h3 class="text-lg font-bold mb-2">آماده همکاری هستی؟</h3>
                                    <p class="text-sm text-light-muted dark:text-dark-muted">بیا با هم یه پروژه خفن بسازیم</p>
                                </div>
                                <div class="flex gap-3">
                                    <a href="#contact" class="px-6 py-3 bg-gradient-to-r from-accent-red to-accent-purple rounded-xl text-white font-bold hover:scale-105 transition shadow-lg">
                                        شروع پروژه
                                    </a>
                                    <a href="#about" class="px-6 py-3 border border-accent-purple rounded-xl font-bold hover:bg-accent-purple/10 transition">
                                        درباره من
                                    </a>
                                </div>
                            </div>
                ...
                <div class="h-px bg-gradient-to-r from-transparent via-accent-purple/30 to-transparent my-10"></div>
                <div class="flex flex-col md:flex-row justify-between items-center text-xs text-light-muted dark:text-dark-muted">
                    ...
                    <p class="mt-2 md:mt-0">کدها در <span class="text-accent-purple">GitHub</span> موجود است</p>
                </div>
            </div>
        </footer>
